...
public class DriverManager {
    ...
    public void takeElementscreenshot(WebElement element, String fileName)  {
        ...
        try {
            FileUtils.copyFile(scnFile, new File("/Users/sutha/Desktop/screenshot/Error.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
//take a screen shot
        ...
        try {
            FileUtils.copyFile(scrFile, new File("/Users/sutha/Desktop/screenshot/Error.jpg"));
        } catch (IOException e) {
